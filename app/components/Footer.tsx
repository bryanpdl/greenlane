...
const footerLinks = {
  platform: {
    title: 'Platform',
    links: [
      { name: 'Explore Shops', href: '/explore' },
...
export default function Footer() {
  return (
    <footer className="bg-green-base/50 mt-auto">
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              {socialLinks.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-gray-400 hover:text-green-accent"
                >
            ...
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} GreenLane. All rights reserved.
            </p>
          </div>
        </div>
      </div>
